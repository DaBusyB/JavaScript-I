...
let lastCar = 0;
console.log("challenge 2:", inventory[inventory.length - 1].car_make, inventory[inventory.length - 1].car_model);
...
for (let i = 0; i < inventory.length; i++) {
    let currentCar = inventory[i].car_year;
    carYears.push(currentCar);
}
...
for (let i = 0; i < carYears.length; i++) {
    let curCar = carYears[i];
    curCar < 2000 ? oldCars.push(curCar) : null;
}
...
for (let i = 0; i < inventory.length; i++) {
    const currentCar = inventory[i].car_make;
